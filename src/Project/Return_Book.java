...
public class Return_Book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        materialButton1.setText("Return");
    ...
    private void materialButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton1ActionPerformed
        if (!bID.getText().isEmpty() && !SID.getText().isEmpty()){
            ...
            borrow.connection("SELECT * FROM borrow WHERE BookID =" + id + " AND StudentID =" + sid);
            Date dateb = borrow.getReturnDate();
            Date dateR=  due_date.getDatoFecha();
            long l2 = dateR.getTime();
            java.sql.Date dater = new java.sql.Date(l2);
            int Penalty = penalty((java.sql.Date) dateb);
            ...
            int numberOfBooks = student.getNbooks();
            if (numberOfAvailbleBooks == 0 && numberOfBooks > 0) {
                ...
                book.update("UPDATE Book SET Quantity =" + numberOfAvailbleBooks +
                        ",BorrowedBooks =" + numberOfBorrowedBooks + ",Availble = true WHERE Book_ID =" + id);
                student.update("UPDATE Students SET NBooks =" + numberOfBooks + " WHERE Stud_ID =" + sid );
                borrow.update("DELETE FROM Borrow WHERE BookID =" + id + " AND StudentID =" + sid);
                JOptionPane.showMessageDialog(this, "DONE !", "Warning", JOptionPane.INFORMATION_MESSAGE);
                history.update("UPDATE BorrowHistory SET ActualReturnDate = '" + dater +"', Penalty =  " + Penalty +" WHERE BookID =" + id + " AND StudentID =" + sid);
                if (Penalty >0 ) {
                    JOptionPane.showMessageDialog(this, "RETURNED ! \n The student must be billed : " + Penalty + " TND" , "Warning", JOptionPane.INFORMATION_MESSAGE);
                }
                JOptionPane.showMessageDialog(this, "DONE !", "Warning", JOptionPane.INFORMATION_MESSAGE);
                ...
                history.update("UPDATE BorrowHistory SET ActualReturnDate = '" + dater +"', Penalty =  " + Penalty + " WHERE BookID =" + id + " AND StudentID =" + sid);
                if (Penalty >0 ) {
                    JOptionPane.showMessageDialog(this, "RETURNED ! \n The student must be billed : " + Penalty, "Warning", JOptionPane.INFORMATION_MESSAGE);
                }
                ...
                JOptionPane.showMessageDialog(this, "This student has already borrowed 2 books", "Warning", JOptionPane.WARNING_MESSAGE);
